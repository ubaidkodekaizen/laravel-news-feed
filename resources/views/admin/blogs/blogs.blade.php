            ...
            <div class="row">
                <div class="col-12">
                    <div class="card" style="border: none;">
                        ...
                        <div class="card-body">
                            <!-- Tabs Navigation -->
                            <ul class="nav nav-tabs mb-4 pb-3" id="blogTabs" role="tablist" style="border-bottom: 2px solid #E1E0E0;">
                                ...
                                <tbody>
                                    @forelse($blogs as $blog)
                                        <tr>
                                            ...
                                            <td>
                                                @if($canView)
                                                <a href="{{ route('admin.view.blog', $blog->id) }}" class="btn btn-warning btn-sm">
                                                ...
                                                @if($filter !== 'deleted')
                                                    @if($canEdit)
                                                    <a id="edit" href="{{ route('admin.edit.blog', $blog->id) }}"
