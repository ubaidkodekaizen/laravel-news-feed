                                ...
                                <div class="event_slider">
                                    <div class="container">
                                                            ...
                                                            @if ($user->linkedin_url)
                                                                <li>
                                                                    <a href="{{ $user->linkedin_url }}" target="_blank"
                                                                        ...
                                                                        <img src="{{ asset('assets/images/linkedInIcon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            @if ($user->facebook_url)
                                                                <li>
                                                                    <a href="{{ $user->facebook_url }}" target="_blank"
                                                                        title="Facebook">
                                                                        <img src="{{ asset('assets/images/facebookIcon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            ...
                                                            @if ($user->x_url)
                                                                <li>
                                                                    <a href="{{ $user->x_url }}" target="_blank"
                                                                        ...
                                                                        <img src="{{ asset('assets/images/twitterXiCon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            ...
                                                            @if ($user->instagram_url)
                                                                <li>
                                                                    <a href="{{ $user->instagram_url }}" target="_blank"
                                                                        title="Instagram">
                                                                        <img src="{{ asset('assets/images/instagramIcon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            ...
                                                            @if ($user->tiktok_url)
                                                                <li>
                                                                    <a href="{{ $user->tiktok_url }}" target="_blank"
                                                                        title="TikTok">
                                                                        <img src="{{ asset('assets/images/tiktokIcon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                                            ...
                                                            @if ($user->youtube_url)
                                                                <li>
                                                                    <a href="{{ $user->youtube_url }}" target="_blank"
                                                                        title="YouTube">
                                                                        <img src="{{ asset('assets/images/youtubeIcon.svg') }}"
                                                                            alt="">
                                                                    </a>
                                                                </li>
                                                            @endif
                                            ...
                                            <div class="profileInfoInner">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        ...
                                                        <p class="profileInfoInnerInfoAns">{{ $user->first_name ?? '' }}
                                                        </p>
                                                    </div>
                                                    <div class="col-lg-3">
                                        ...
                                        <div class="offeredHeadingMain">
                                            ...
                                            <p>A look at the products our MuslimLynk members are offering. Created by real
                                                people in our community, for others who can benefit from them.</p>
                                        </div>
                                        <div class="swiper">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            krTriggers.forEach(function(trigger) {
                trigger.addEventListener('mouseenter', function() {
                    ...
                    const top = triggerRect.top + (triggerRect.height / 2) - (tooltipRect.height /
                        2) + window.scrollY;
