...
<style>
    ...
    div#feedTable_filter label::after {
        content: "";
        position: absolute;
        right: 18px;
        top: 50%;
                ...
                <div class="col-12">
                    <div class="card" style="border: none;">
                        <div class="card-header card_header_flex">
                            <h4 class="card-title">Feed Posts</h4>
                        </div>
                        <div class="card-body">
                            <!-- Tabs Navigation -->
                            <ul class="nav nav-tabs mb-4 pb-3" id="feedTabs" role="tablist" style="border-bottom: 2px solid #E1E0E0;">
                                <li class="nav-item" role="presentation">
                                    <a class="nav-link {{ $filter === 'all' ? 'active' : '' }}"
                                       href="{{ route('admin.feed', ['filter' => 'all']) }}"
                                ...
                                <li class="nav-item delete" role="presentation">
                                    <a class="nav-link {{ $filter === 'deleted' ? 'active' : '' }}"
                                       href="{{ route('admin.feed', ['filter' => 'deleted']) }}"
                                       style="color: #333; font-family: 'Inter'; font-weight: 500; padding: 12px 20px; border: none;">
                                ...
                                <tbody>
                                    @forelse($posts as $post)
                                        <tr>
                                            ...
                                            <td>{{ $post->shares_count ?? 0 }}</td>
                                            <td>{{ $post->created_at ? $post->created_at->format('m/d/Y H:i') : 'N/A' }}</td>
                                            <td>
                                                @if($canView)
