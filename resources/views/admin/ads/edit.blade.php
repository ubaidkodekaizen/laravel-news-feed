                                    ...
                                    <div class="col-lg-7 col-md-6">
                                        <div class="row">
                                            ...
                                            <div class="col-12 mb-3">
                                                <label for="media" class="form-label">Media (Image, GIF, or Video)</label>
                                                <input 
                                                    type="file" 
                                                    id="media" 
                                                    name="media" 
                                                ...
                                                <small class="form-text text-muted">
                                                    ...
                                                    Leave empty to keep current media. Accepted formats: JPG, PNG, GIF, MP4, MOV, AVI, WEBM (Max 10MB)
                                                </small>
                                                @error('media')
                                        ...
                                        <div class="preview-container">
                                            <div id="mediaPreview">
                                                @if($ad->media)
                                                    ...
                                                    @endphp
                                                    @if($isVideo)
                                                        <video src="{{ $mediaUrl }}" controls style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                                            Your browser does not support the video tag.
                                                        </video>
                                                    @else
                                                        <img src="{{ $mediaUrl }}" alt="Current Media" style="max-width: 100%; max-height: 100%; object-fit: contain;">
                                                    @endif
                                                @else
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        mediaInput.addEventListener('change', function(e) {
            ...
            // If file is cleared, the existing preview in the HTML will remain visible
        });
    });
</script>
@endsection
