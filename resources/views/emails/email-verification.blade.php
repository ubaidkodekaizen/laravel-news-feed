...
<head>
	...
	<style type="text/css" media="screen">
		...
		.gradient { background: linear-gradient(90deg, rgb(40 40 40) 0%, rgb(60 58 58) 100%, rgb(12 12 12) 50%);}
		

		/* .btn-secondary { border-radius: 10px; background: linear-gradient(to right, #9028df 0%,#000000 100%); } */
		.btn-secondary { border-radius: 10px;     background: linear-gradient(90deg, rgb(40 40 40) 0%, rgb(60 58 58) 100%, rgb(12 12 12) 50%);}
...
<body class="body" style="padding:0 !important; margin:0 auto !important; display:block !important; min-width:100% !important; width:100% !important; background:#f8f7f8; -webkit-text-size-adjust:none;">
	<center>
		<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin: 0; padding: 0; width: 100%; height: 100%;" bgcolor="#eeedee" class="gwfw">
			<tr>
								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td class="mpx-10">
											...
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
												<tr>
													<td class="pt-10 pb-10" style="border-radius: 10px; padding-top: 10px; padding-bottom: 10px;" bgcolor="#273572">
														<table width="100%" border="0" cellspacing="0" cellpadding="0">
															<tr>
