                        ...
                        <form method="POST" action="{{ route('admin.update.service', $service->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    @if($service->service_image)
                                        <small class="text-muted">Current image: <a href="{{ $service->service_image }}" target="_blank">View</a></small>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <textarea class="form-control" id="short_description" name="short_description" rows="4">{{ old('short_description', $service->short_description) }}</textarea>
                                </div>
                            </div>
