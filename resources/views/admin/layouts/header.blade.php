...
<style>
    ...
    .sidebar-menu li a:hover svg#schedulerIcon,
    .sidebar-menu li a.active svg#schedulerIcon,
    .sidebar-menu li a:hover svg#schedulerIcon path,
    .sidebar-menu li a.active svg#schedulerIcon path,
    .sidebar-menu li a:hover svg#schedulerIcon circle,
    .sidebar-menu li a.active svg#schedulerIcon circle{
    ...
    <div class="admin-panel">
        <aside id="dashboardSidebar" class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                {{-- Feed - Check permission --}}
                @if($isAdmin || ($user && $user->hasPermission('feed.view')))
                <li>
                    <a href="{{ route('admin.feed') }}"
                        class="{{ request()->routeIs('admin.feed*') ? 'active' : '' }}">
                        <svg width="20px" height="20px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <title>Feed</title>
                            <path d="M3 3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3ZM4 5V19H20V5H4ZM6 7H18V9H6V7ZM6 11H18V13H6V11ZM6 15H14V17H6V15Z" fill="#333"/>
                        </svg>
