                            ...
                            <div class="company_card">
                                ...
                                <div class="company_card_details">
                                    ...
                                    <div class="company_experience">
                                        ...
                                        <div data-kr-tooltip="true" title="Business Type">{{ $user->company->company_business_type }}</div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="company_position">
                                        ...
                                        <div data-kr-tooltip="true" title="Position">{{ $user->company->company_position }}</div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="company_experience">
                                        ...
                                        <div data-kr-tooltip="true" title="Experience">{{ $user->company->company_experience }}</div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="company_experience">
                                        ...
                                        <div data-kr-tooltip="true" title="Revenue"> ${{ $user->company->company_revenue }}</div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="company_experience">
                                        ...
                                        <div data-kr-tooltip="true" title="Number of Employees">{{ $user->company->company_no_of_employee }}</div>
                                    </div>
                                    @endif
                                    ...
                                    <div class="company_experience">
                                        ...
                                        <div data-kr-tooltip="true" title="Industry">{{ $user->company->company_industry }}</div>
                                    </div>
                                    @endif
                                </div>
...
<script>
    ...
    // ===== CLEAN & UPDATED TOOLTIP SCRIPT =====
    document.addEventListener('DOMContentLoaded', function() {
        const krTriggers = document.querySelectorAll('[data-kr-tooltip="true"]');
        let krActiveTooltip = null;

        krTriggers.forEach(function(trigger) {
            trigger.addEventListener('mouseenter', function() {
                const text = trigger.getAttribute('title') || trigger.getAttribute('data-kr-title');

                if (!text) return;

                if (!trigger.getAttribute('data-kr-title')) {
                    trigger.setAttribute('data-kr-title', text);
                    trigger.removeAttribute('title');
                }

                if (krActiveTooltip) {
                    krActiveTooltip.remove();
                }

                krActiveTooltip = document.createElement('div');
                krActiveTooltip.className = 'krTooltipBox';
                krActiveTooltip.textContent = text;
                document.body.appendChild(krActiveTooltip);

                const triggerRect = trigger.getBoundingClientRect();
                const tooltipRect = krActiveTooltip.getBoundingClientRect();

                // Position tooltip to RIGHT of the element
                const left = triggerRect.right + 10 + window.scrollX;
                const top = triggerRect.top + (triggerRect.height / 2) - (tooltipRect.height / 2) + window.scrollY;

                krActiveTooltip.style.left = left + 'px';
                krActiveTooltip.style.top = top + 'px';

                setTimeout(function() {
                    if (krActiveTooltip) {
                        krActiveTooltip.classList.add('krTooltipBox--visible');
                    }
                }, 10);
            });
            ...
            trigger.addEventListener('mouseleave', function() {
                if (krActiveTooltip) {
                    krActiveTooltip.classList.remove('krTooltipBox--visible');
                    const tooltipToRemove = krActiveTooltip;
                    setTimeout(function() {
                        tooltipToRemove.remove();
                    }, 300);
                    krActiveTooltip = null;
                }
            });
        });
    });
