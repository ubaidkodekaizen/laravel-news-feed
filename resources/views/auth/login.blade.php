...
<head>
    ...
    <title>Sign In | Muslim Lynk</title>
...
<style>
    ...
    h2, .input-box .icon, input:-webkit-autofill, .input-box label:last-child{
            color: #000;
            ...
            <div class="row loginInner">
                <div class="col-lg-5 mobile_hide">
                    <!-- <div class="img_side_width"> -->
                        <img src="{{ asset('assets/images/1dbb64827f461da7b2ac20501ad9781821e1d278.jpg') }}" alt="" class="signInImage img-fluid">
                    <!-- </div> -->
                    ...
                    <div class="form-section">
                        ...
                        <form action="{{route('login')}}" class="form" method="POST" autocomplete="off">
                            ...
                            <div class="input-box">
                                ...
                                <input type="password" id="password" name="password" autocomplete="off" placeholder="Enter Password" required>
                            ...
                            <div class="account_signup accountSignup">
                                <a href="{{route('register.form')}}">Don't have an account? <span class="theme-color">Create account</span> </a>
                            </div>
                        </form>
                    </div>
                </div>
